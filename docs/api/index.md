...
| Function | Description |
|----------|-------------|
| [`ES_CCF()`](algorithms.md#es_ccf) | Entropy Sorting Combinatorial Cluster Finder — find the combination of clusters that maximises ESS correlation for each gene |
